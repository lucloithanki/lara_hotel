                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    data-validation="length" data-validation-length="min10" data-validation-error-msg="* Không để trống & > 10 ký tự </br> * Chỉ nhập chữ và số">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Slug</label>
                                    <input type="text" name="product_slug" class="form-control" id="exampleInputEmail1" value="{{$pro->product_slug}}"
                                    data-validation="length" data-validation-length="20" data-validation-error-msg="*Không được để trống bắt buộc">
                                </div>
                                     <div class="form-group">
                                    <label for="exampleInputEmail1">Giá sản phẩm</label>
                                    <input type="text" value="{{$pro->product_price}}" name="product_price" class="form-control" id="exampleInputEmail1" 
                                    data-validation="number" data-validation-error-msg="* Hãy điền giá sản phẩm </br> * Chỉ sử dụng số" >
                                </div>
                                  <div class="form-group">
